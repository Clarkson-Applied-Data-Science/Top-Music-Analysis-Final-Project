...
## Files in this Repo
- Results.xlsx
  - The destination of the results from this analysis. Saved as excel to provide ease of creating graphs
- spotify_analysis.py
  - Python file responsible for aggregating each years' data into a dictionary of average values
- spotify_json_data.json
  - Generated by the SpotifyTop100.py file. This json contains all of the data analyzed for each song in each year
- SpotifyQuery.ipynb and Webscraper.ipynb (OBSOLETE)
  - The initial Jyptyr notebook files used to test the webscraping and Spotify queries. These files were abandoned to combine into the SpotifyTop100.py and were further edited there
- SpotifyTop100.py
  - This is the Python script used to scrape Wikipedia, search that song on Spotify, and create the json file that will be saved locally.
